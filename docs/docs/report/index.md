...
!!! tip "Read the Source"
    The source code for the default reports is [available on GitHub]({{ sourcedir("src/backend/Tracklet/report/templates/report") }}). Use this as a guide for generating your own reports!
