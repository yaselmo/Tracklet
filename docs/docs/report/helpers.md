...
!!! tip "Use the Source, Luke"
    To see the full range of available helper functions, refer to the source file [report.py]({{ sourcefile("src/backend/Tracklet/report/templatetags/report.py") }}) where these functions are defined!
