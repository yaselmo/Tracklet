...
The configuration file *template* can be found on [GitHub]({{ sourcefile("src/backend/Tracklet/config_template.yaml") }}), and is shown below:

{{ includefile("src/backend/Tracklet/config_template.yaml", "Configuration File Template", fmt="yaml") }}
