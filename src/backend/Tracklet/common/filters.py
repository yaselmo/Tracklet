"""Custom API filters for Tracklet."""
...
def filter_parameters_by_value(
    ...
    if template.checkbox:
        ...
        bool_value = Tracklet.helpers.str2bool(value)
        ...
        try:
            value_numeric = Tracklet.conversion.convert_physical_value(
...
def enable_project_code_filter(default: bool = True):
    ...
    return Tracklet.serializers.enable_filter(
...
def enable_project_label_filter(default: bool = True):
    ...
    """
    return Tracklet.serializers.enable_filter(
        Tracklet.serializers.FilterableCharField(
...
def enable_tags_filter(default: bool = False):
    ...
    """
    from Tracklet.serializers import FilterableTagListField
