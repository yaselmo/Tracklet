...
def currency_code_default(create: bool = True):
    ...
    from Tracklet.ready import isRunningBackup, isRunningMigrations
    ...
    if Tracklet.ready.isAppLoaded('common'):
        try:
...
def after_change_currency(setting) -> None:
    ...
    Tracklet.tasks.update_exchange_rates(force=True)
...
def get_price(
    ...
    if pb_found:
        ...
        return Tracklet.helpers.normalize(cost + instance.base_cost)
    return None
