...
from Tracklet.unit_test import (
    AdminTestCase,
...
class SettingsTest(InvenTreeTestCase):
    ...
    def test_settings_objects(self):
        ...
        self.assertEqual(instance_name.value, 'My very first Tracklet Instance')
    ...
    def test_settings_functions(self):
        ...
        # check as_choice
        self.assertEqual(instance_obj.as_choice(), 'My very first Tracklet Instance')
...
class GlobalSettingsApiTest(InvenTreeAPITestCase):
    ...
    def test_api_detail(self):
        ...
        self.assertEqual(response.data['value'], 'Tracklet')
