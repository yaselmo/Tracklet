...
from Tracklet.models import InvenTreeNotesMixin
...
def cleanup_old_data_outputs():
    ...
    threshold = Tracklet.helpers.current_date() - timedelta(days=5)
...
def delete_old_notes_images():
    ...
    before = Tracklet.helpers.current_date() - timedelta(days=90)
