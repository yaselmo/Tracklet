...
from Tracklet.cache import get_session_cache, set_session_cache
from Tracklet.sanitizer import sanitize_svg
from Tracklet.tracing import TRACE_PROC, TRACE_PROV
from Tracklet.version import inventree_identifier
...
class UpdatedUserMixin(models.Model):
    ...
    def save(self, *args, **kwargs):
        ...
        self.updated = Tracklet.helpers.current_time()
...
class ProjectCode(Tracklet.models.InvenTreeMetadataModel):
...
class BaseInvenTreeSetting(models.Model):
        ...
        **kwargs,
        ...
        for key, setting in settings.items():
            ...
            if cls.is_protected(key, **filters) and setting.value != '':
                ...
                setting.value = Tracklet.helpers.str2bool(setting.value)
    ...
    def get_setting_object(cls, key, **kwargs):
        ...
        if (
            Tracklet.ready.isImportingData()
            or Tracklet.ready.isRunningMigrations()
            or Tracklet.ready.isRebuildingData()
            or Tracklet.ready.isRunningBackup()
        ):  # pragma: no cover
            create = False
    ...
    def get_setting(cls, key, backup_value=None, **kwargs):
        ...
        if setting:
            ...
            if setting.is_bool():
                value = Tracklet.helpers.str2bool(value)
    ...
    def run_validator(self, validator):
        ...
        if validator is bool:
            ...
            if Tracklet.helpers.is_bool(value):
    ...
    def as_bool(self):
        ...
        """
        return Tracklet.helpers.str2bool(self.value)
...
class InvenTreeSetting(BaseInvenTreeSetting):
    ...
    def save(self, *args, **kwargs):
        ...
        if self.requires_restart() and not Tracklet.ready.isImportingData():
...
class PriceBreak(MetaMixin):
    ...
    quantity = Tracklet.fields.RoundingDecimalField(
        max_digits=15,
        decimal_places=5,
        default=1,
    ...
    price = Tracklet.fields.InvenTreeModelMoneyField(
        max_digits=19,
        decimal_places=6,
        null=True,
...
class NotificationEntry(MetaMixin):
    ...
    def check_recent(cls, key: str, uid: int, delta: timedelta):
        ...
        since = Tracklet.helpers.current_date() - delta
...
class CustomUnit(models.Model):
    ...
    def clean(self):
        ...
        from Tracklet.conversion import get_unit_registry
...
def after_custom_unit_updated(sender, instance, **kwargs):
    ...
    from Tracklet.conversion import reload_unit_registry
...
class Attachment(Tracklet.models.MetadataMixin, Tracklet.models.InvenTreeModel):
    ...
    link = Tracklet.fields.InvenTreeURLField(
        blank=True,
        null=True,
        verbose_name=_('Link'),
    ...
    def fully_qualified_url(self):
        ...
        if self.attachment:
            ...
            media_url = Tracklet.helpers.getMediaUrl(self.attachment)
            return Tracklet.helpers_model.construct_absolute_url(media_url)

        return ''

    def check_permission(self, permission, user):
        """Check if the user has the required permission for this attachment."""
        from Tracklet.models import InvenTreeAttachmentMixin
...
class InvenTreeCustomUserStateModel(models.Model):
    ...
    def get_status_class(self):
        ...
        from Tracklet.helpers import inheritors
...
class SelectionList(Tracklet.models.MetadataMixin, Tracklet.models.InvenTreeModel):
...
class ParameterTemplate(
    Tracklet.models.MetadataMixin, Tracklet.models.InvenTreeModel
):
    ...
    units = models.CharField(
        ...
        blank=True,
        validators=[Tracklet.validators.validate_physical_units],
    )
...
class Parameter(
    UpdatedUserMixin, Tracklet.models.MetadataMixin, Tracklet.models.InvenTreeModel
):
    ...
    def save(self, *args, **kwargs):
        ...
        if self.template.checkbox:
            self.data = Tracklet.helpers.str2bool(self.data)
    ...
    def clean(self):
        ...
        for plugin in registry.with_mixin(PluginMixinEnum.VALIDATION):
            ...
            try:
                ...
                Tracklet.exceptions.log_error('validate_parameter', plugin=plugin.slug)
    ...
    def calculate_numeric_value(self):
        ...
        if self.template.units:
            try:
                self.data_numeric = Tracklet.conversion.convert_physical_value(
                    self.data, self.template.units
                )
    ...
    def check_permission(self, permission, user):
        ...
        from Tracklet.models import InvenTreeParameterMixin
    ...
    def check_save(self):
        ...
        except Tracklet.models.InvenTreeModel.DoesNotExist:
            return
...
class BarcodeScanResult(Tracklet.models.InvenTreeModel):
...
class EmailThread(Tracklet.models.InvenTreeMetadataModel):
...
def handle_inbound(sender, event, esp_name, **kwargs):
    ...
    Tracklet.tasks.offload_task(process_mail_in, mail_id=msg.pk, group='mail')
