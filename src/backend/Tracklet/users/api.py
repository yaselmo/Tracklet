...
from Tracklet.settings import FRONTEND_URL_BASE
...
class UserDetail(RetrieveUpdateDestroyAPI):
    ...
    permission_classes = [Tracklet.permissions.StaffRolePermissionOrReadOnly]
...
class UserDetailSetPassword(UpdateAPI):
    ...
    permission_classes = [Tracklet.permissions.IsSuperuserOrSuperScope]
...
class GroupMixin(SerializerContextMixin):
    ...
    permission_classes = [Tracklet.permissions.IsStaffOrReadOnlyScope]
