...
from Tracklet.helpers_mixin import get_shared_class_instance_state_mixin
...
def machine_registry_entrypoint(
    ...
    def decorator(method):
        ...
        def wrapper(self, *args, **kwargs):
            ...
            if Tracklet.cache.get_session_cache('machine_registry_checked'):
            ...
            Tracklet.cache.set_session_cache('machine_registry_checked', True)
...
class MachineRegistry(
    ...
    def reload_machines(self, main: bool = False):
        ...
        Tracklet.cache.set_session_cache('machine_registry_checked', False)
