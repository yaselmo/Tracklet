...
class PluginDetail(RetrieveDestroyAPI):
    ...
    queryset = PluginConfig.objects.all()
    serializer_class = PluginSerializers.PluginConfigSerializer
    permission_classes = [Tracklet.permissions.IsSuperuserOrReadOnlyOrScope]
    lookup_field = 'key'
...
class PluginSettingList(ListAPI):
    ...
    permission_classes = [Tracklet.permissions.GlobalSettingsPermissions]
...
class PluginUserSettingList(APIView):
    ...
    permission_classes = [Tracklet.permissions.UserSettingsPermissionsOrScope]
