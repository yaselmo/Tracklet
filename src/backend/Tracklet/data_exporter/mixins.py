...
class DataExportViewMixin:
    ...
    def export_data(
        ...
        try:
            ...
            Tracklet.exceptions.log_error('filter_queryset', plugin=export_plugin.slug)
        ...
        try:
            ...
            Tracklet.exceptions.log_error('export_data', plugin=export_plugin.slug)
        ...
        try:
            ...
            Tracklet.exceptions.log_error('export_to_file', plugin=export_plugin.slug)
            output.mark_failure(error=str(e))
