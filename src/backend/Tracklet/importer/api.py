...
class DataImporterPermissionMixin:
    ...
    permission_classes = [
        Tracklet.permissions.IsAuthenticatedOrReadScope,
        Tracklet.permissions.DataImporterPermission,
    ]
...
class DataImportSessionMixin:
    ...
    permission_classes = [Tracklet.permissions.DataImporterPermission]
