...
class DataImportSession(models.Model):
    ...
    data_file = models.FileField(
        ...
        validators=[
            FileExtensionValidator(
                allowed_extensions=Tracklet.helpers.GetExportFormats()
            ),
    ...
    def available_fields(self):
        ...
        - We make use of the Tracklet.metadata module to provide extra information about the fields.
        ...
        from Tracklet.metadata import InvenTreeMetadata
