...
def get_backup_connector_options() -> dict:
    ...
    connector_options = Tracklet.config.get_setting(
...
def get_backup_storage_backend() -> str:
    ...
    backend = Tracklet.config.get_setting(
...
def get_backup_storage_options() -> dict:
    ...
    default_options = {'location': Tracklet.config.get_backup_dir()}

    options = Tracklet.config.get_setting(
...
def backup_email_on_error() -> bool:
    ...
    return Tracklet.config.get_setting(
