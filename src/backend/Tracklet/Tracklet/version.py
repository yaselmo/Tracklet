"""Version information for Tracklet.
...
def checkMinPythonVersion():
    ...
    docs = 'https://github.com/yaselmo/Tracklet#readme'

    msg = f"""
    INVE-E15: Python version not supported.
    Tracklet requires Python {V_MIN_MAJOR}.{V_MIN_MINOR} or above - you are running version {version}.
    - Refer to the Tracklet documentation for more information:
    - {docs}
    """
...
def inventreeDocUrl() -> str:
    """Return URL for Tracklet documentation site."""
    return 'https://github.com/yaselmo/Tracklet#readme'


def inventreeAppUrl() -> str:
    """Return URL for Tracklet app site."""
    return 'https://github.com/yaselmo/Tracklet#readme'


def inventreeGithubUrl() -> str:
    """Return URL for Tracklet github site."""
    return 'https://github.com/yaselmo/Tracklet/'
...
def inventreeApiVersion() -> int:
    """Returns current API version of Tracklet."""
