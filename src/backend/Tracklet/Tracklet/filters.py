...
class InvenTreeSearchFilter(filters.SearchFilter):
    ...
    def get_search_fields(self, view, request):
        ...
        """
        search_notes = Tracklet.helpers.str2bool(
        ...
        regex = Tracklet.helpers.str2bool(
    ...
    def get_search_terms(self, request):
        ...
        """
        whole = Tracklet.helpers.str2bool(
...
class NumberOrNullFilter(rest_filters.NumberFilter):
    ...
    def field(self):
        ...
        def custom_clean(val):
            ...
            if Tracklet.helpers.isNull(val) and val is not None:
                return 'null'
