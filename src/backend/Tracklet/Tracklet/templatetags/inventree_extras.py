...
def decimal(x, *args, **kwargs):
    ...
    return Tracklet.helpers.decimal2string(x)
...
def str2bool(x, *args, **kwargs):
    ...
    return Tracklet.helpers.str2bool(x)
...
def inventree_logo(**kwargs):
    ...
    """
    return Tracklet.helpers.getLogoImage(**kwargs)
...
def inventree_installer(*args, **kwargs):
    ...
    return Tracklet.config.inventreeInstaller()
