...
from Tracklet.serializers import DependentField
...
class InvenTreeMetadata(SimpleMetadata):
    ...
    def determine_actions(self, request, view):
        ...
        """
        from Tracklet.api import BulkUpdateMixin
    ...
    def determine_metadata(self, request, view):
        ...
        try:
            ...
            self.model = Tracklet.permissions.get_model_for_view(view)
            ...
            rolemap = {**Tracklet.permissions.ACTION_MAP, 'OPTIONS': 'view'}
