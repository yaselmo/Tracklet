...
from Tracklet.cache import create_session_cache, delete_session_cache
from Tracklet.config import CONFIG_LOOKUPS, inventreeInstaller
...
paths_own_security = [
    ...
    '/favicon.ico',  # Public redirect to the application favicon
    ensure_slashes(
        settings.STATIC_URL
