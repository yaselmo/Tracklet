...
from Tracklet.config import get_base_dir
...
class ReportConfig(AppConfig):
    ...
    def ready(self):
        ...
        if (
            not Tracklet.ready.isPluginRegistryLoaded()
            or not Tracklet.ready.isInMainThread()
        ):
            return

        if not Tracklet.ready.canAppAccessDatabase(allow_test=False):
    ...
    def create_default_labels(self):
        ...
        for template in label_templates:
            ...
            try:
                ...
                Tracklet.exceptions.log_error('create_default_labels', scope='init')
    ...
    def create_default_reports(self):
        ...
        for template in report_templates:
            ...
            try:
                ...
                Tracklet.exceptions.log_error('create_default_reports', scope='init')
