    ...
    operations = [
            ...
            field=generic.states.fields.ExtraInvenTreeCustomStatusModelField(
                ...
                validators=[
                    generic.states.validators.CustomStatusCodeValidator(
                        status_class=Tracklet.status_codes.PurchaseOrderStatus
                    ),
                ]
            ),
        ),
        migrations.AddField(
            ...
            field=generic.states.fields.ExtraInvenTreeCustomStatusModelField(
                ...
                validators=[
                    generic.states.validators.CustomStatusCodeValidator(
                        status_class=Tracklet.status_codes.ReturnOrderStatus
                    ),
                ]
            ),
        ),
        migrations.AddField(
            ...
            field=generic.states.fields.ExtraInvenTreeCustomStatusModelField(
                ...
                validators=[
                    generic.states.validators.CustomStatusCodeValidator(
                        status_class=Tracklet.status_codes.ReturnOrderLineStatus
                    ),
                ]
            ),
        ),
        migrations.AddField(
            ...
            field=generic.states.fields.ExtraInvenTreeCustomStatusModelField(
                ...
                validators=[
                    generic.states.validators.CustomStatusCodeValidator(
                        status_class=Tracklet.status_codes.SalesOrderStatus
                    ),
                ]
            ),
        ),
        migrations.AlterField(
            ...
            field=generic.states.fields.InvenTreeCustomStatusModelField(
                choices=Tracklet.status_codes.PurchaseOrderStatus.items(),
                default=10,
        ...
        migrations.AlterField(
            ...
            name="status",
            field=generic.states.fields.InvenTreeCustomStatusModelField(
                choices=Tracklet.status_codes.ReturnOrderStatus.items(),
                default=10,
        ...
        migrations.AlterField(
            ...
            name="outcome",
            field=generic.states.fields.InvenTreeCustomStatusModelField(
                choices=Tracklet.status_codes.ReturnOrderLineStatus.items(),
                default=10,
        ...
        migrations.AlterField(
            ...
            name="status",
            field=generic.states.fields.InvenTreeCustomStatusModelField(
                choices=Tracklet.status_codes.SalesOrderStatus.items(),
                default=10,
