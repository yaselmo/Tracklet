...
def notify_overdue_purchase_order(po: order.models.PurchaseOrder) -> None:
    ...
    context = {
        ...
        'link': Tracklet.helpers_model.construct_absolute_url(po.get_absolute_url()),
...
def notify_overdue_sales_order(so: order.models.SalesOrder) -> None:
    ...
    context = {
        ...
        'link': Tracklet.helpers_model.construct_absolute_url(so.get_absolute_url()),
...
def notify_overdue_return_order(ro: order.models.ReturnOrder) -> None:
    ...
    context = {
        ...
        'link': Tracklet.helpers_model.construct_absolute_url(ro.get_absolute_url()),
