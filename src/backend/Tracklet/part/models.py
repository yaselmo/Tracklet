...
from Tracklet import helpers, validators
from Tracklet.exceptions import log_error
from Tracklet.fields import InvenTreeURLField
from Tracklet.helpers import decimal2money, decimal2string, normalize
...
class PartCategory(
    ...
    requires_calibration = models.BooleanField(
        default=False,
        verbose_name=_('Requires Calibration'),
        help_text=_('Parts in this category require periodic calibration'),
    )
    ...
    calibration_interval_days = models.PositiveIntegerField(
        ...
        help_text=_('Default calibration interval for parts in this category'),
    )
    ...
    def clean(self):
        ...
        if self.requires_calibration and not self.calibration_interval_days:
            raise ValidationError({
...
class PartCategoryParameterTemplate(Tracklet.models.InvenTreeMetadataModel):
    ...
    def clean(self):
        ...
        if (
            ...
            try:
                Tracklet.conversion.convert_physical_value(
...
class Part(
    ...
    def get_next_serial_number(self):
        ...
        return Tracklet.helpers.increment_serial_number(sn, self)
    ...
    def available_stock(self):
        ...
        - tracklet_status must be IN_STOCK or IN_USE
        - broken and missing quantities are excluded
    ...
    def validate_bom(self, user, valid: bool = True):
        ...
        self.bom_checked_date = Tracklet.helpers.current_date()
...
def after_save_part(sender, instance: Part, created, **kwargs):
    ...
    if instance and not created and not Tracklet.ready.isImportingData():
...
class PartPricing(common.models.MetaMixin):
    ...
    def schedule_for_update(self, counter: int = 0, refresh: bool = True):
        ...
        if Tracklet.ready.isRunningMigrations():
            return
    ...
    def update_purchase_cost(self, save=True):
        ...
        if get_global_setting('PRICING_USE_STOCK_PRICING', True):
            ...
            if days > 0:
                date_threshold = Tracklet.helpers.current_date() - timedelta(days=days)
    ...
    bom_cost_min = Tracklet.fields.InvenTreeModelMoneyField(
        null=True,
        blank=True,
    ...
    bom_cost_max = Tracklet.fields.InvenTreeModelMoneyField(
        null=True,
        blank=True,
    ...
    purchase_cost_min = Tracklet.fields.InvenTreeModelMoneyField(
        null=True,
        blank=True,
    ...
    purchase_cost_max = Tracklet.fields.InvenTreeModelMoneyField(
        null=True,
        blank=True,
    ...
    internal_cost_min = Tracklet.fields.InvenTreeModelMoneyField(
        null=True,
        blank=True,
    ...
    internal_cost_max = Tracklet.fields.InvenTreeModelMoneyField(
        null=True,
        blank=True,
    ...
    supplier_price_min = Tracklet.fields.InvenTreeModelMoneyField(
        null=True,
        blank=True,
    ...
    supplier_price_max = Tracklet.fields.InvenTreeModelMoneyField(
        null=True,
        blank=True,
    ...
    variant_cost_min = Tracklet.fields.InvenTreeModelMoneyField(
        null=True,
        blank=True,
    ...
    variant_cost_max = Tracklet.fields.InvenTreeModelMoneyField(
        null=True,
        blank=True,
    ...
    override_min = Tracklet.fields.InvenTreeModelMoneyField(
        null=True,
        blank=True,
    ...
    override_max = Tracklet.fields.InvenTreeModelMoneyField(
        null=True,
        blank=True,
    ...
    overall_min = Tracklet.fields.InvenTreeModelMoneyField(
        null=True,
        blank=True,
        verbose_name=_('Minimum Cost'),
    ...
    overall_max = Tracklet.fields.InvenTreeModelMoneyField(
        null=True,
        blank=True,
        verbose_name=_('Maximum Cost'),
    ...
    sale_price_min = Tracklet.fields.InvenTreeModelMoneyField(
        null=True,
        blank=True,
    ...
    sale_price_max = Tracklet.fields.InvenTreeModelMoneyField(
        null=True,
        blank=True,
    ...
    sale_history_min = Tracklet.fields.InvenTreeModelMoneyField(
        null=True,
        blank=True,
    ...
    sale_history_max = Tracklet.fields.InvenTreeModelMoneyField(
        null=True,
        blank=True,
...
class PartStocktake(models.Model):
    ...
    cost_min = Tracklet.fields.InvenTreeModelMoneyField(
        null=True,
        blank=True,
    ...
    cost_max = Tracklet.fields.InvenTreeModelMoneyField(
        null=True,
        blank=True,
...
class PartTestTemplate(Tracklet.models.InvenTreeMetadataModel):
...
class BomItem(Tracklet.models.MetadataMixin, Tracklet.models.InvenTreeModel):
...
def update_bom_build_lines(sender, instance, created, **kwargs):
    ...
    if Tracklet.ready.canAppAccessDatabase() and not Tracklet.ready.isImportingData():
        import build.tasks
...
def update_pricing_after_edit(sender, instance, created, **kwargs):
    ...
    if (
        Tracklet.ready.canAppAccessDatabase(allow_test=settings.TESTING_PRICING)
        and not Tracklet.ready.isImportingData()
    ):
        if instance.part:
...
class BomItemSubstitute(Tracklet.models.InvenTreeMetadataModel):
...
class PartRelated(Tracklet.models.InvenTreeMetadataModel):
