...
def notify_low_stock(part: Model):
    ...
    context = {
        ...
        'name': name,
        'message': message,
        'link': Tracklet.helpers_model.construct_absolute_url(part.get_absolute_url()),
...
def notify_stale_stock(user, stale_items):
    ...
    for stock_item in stale_items:
        ...
        item_data = {
            ...
            'absolute_url': Tracklet.helpers_model.construct_absolute_url(
