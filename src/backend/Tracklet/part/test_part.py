...
from Tracklet.templatetags import inventree_extras
from Tracklet.unit_test import InvenTreeTestCase, addUserPermission
...
class TemplateTagTest(InvenTreeTestCase):
    ...
    def test_inventree_instance_name(self):
        ...
        self.assertEqual(inventree_extras.inventree_instance_name(), 'Tracklet')

    def test_inventree_title(self):
        """Test the 'inventree_title' setting."""
        self.assertEqual(inventree_extras.inventree_title(), 'Tracklet')
