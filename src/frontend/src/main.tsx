...
declare global {
  interface Window {
    ...
    TRACKLET_ELECTRON?: TrackletElectronBridge;
    react: typeof React;
    React: typeof React;
...
const configuredApiHost =
  import.meta.env.VITE_API_HOST || window.TRACKLET_ELECTRON?.apiHost;
...
window.INVENTREE_SETTINGS = {
  ...
  ...loaded_vals,
  ...(configuredApiHost ? { api_host: configuredApiHost } : {}),
  ...(configuredBaseUrl ? { base_url: configuredBaseUrl } : {})
};
