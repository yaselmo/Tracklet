...
export function extractAvailableFields(
  ...
  // Some deployments can return 204 for OPTIONS with no metadata body.
  // In that case, fall back to any frontend-provided field definitions.
  if (response.status === 204) {
    return {};
  }

  // OPTIONS request *must* otherwise return 200 status
