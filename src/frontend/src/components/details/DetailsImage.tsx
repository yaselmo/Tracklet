...
export type DetailImageProps = {
  ...
  pk: string;
  existingImageTable?: ComponentType<{
    apiPath: string;
...
function ImageActionButtons({
  ...
  setImage,
  downloadImage,
  existingImageTable: ExistingImageTable
}: Readonly<{
            ...
            <ActionButton
              ...
              onClick={(event: any) => {
                ...
                modals.open({
                  ...
                  size: '80%',
                  children: ExistingImageTable ? (
                    <ExistingImageTable apiPath={apiPath} setImage={setImage} />
                  ) : (
                    <PartThumbTable pk={pk} setImage={setImage} />
                  )
                });
              }}
            />
              ...
              hovered && (
                <Overlay color='black' opacity={0.8} onClick={expandImage}>
                  <ImageActionButtons
                    ...
                    existingImageTable={props.existingImageTable}
                  />
                </Overlay>
              )}
          </>
